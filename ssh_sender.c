/*
 ============================================================================
 Name        : SSH_sender.c
 Author      : Ivan Tretyakov, Mikhail Medvedev
 Version     : 0.1
 Copyright   : GPLv3
...
int main(int argc, char *argv[]) {
	...
	if (argc > 4) {
		...
		fprintf(stderr, "Usage: %s <target ip> <username> <password> <command1> <command2> ... <exit command>\n",
				argv[0]);
		return (EXIT_FAILURE);
	}
	/* Libss2 init block */
